...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user_1, _ = User.objects.get_or_create(
            email='moom200505@spam.ru',
            phone_number='+79151015846',
            password='12345'
        )
        user_2, _ = User.objects.get_or_create(
            email='moom200505@notspam.ru',
            phone_number='+79101015846',
            password='54321'
        )
        ...
        try:
            ...
            lesson_python_start = Lesson.objects.get(
                title='Начало Python',
                course=course_python
            )
            lesson_cpp_end = Lesson.objects.get(
                title='Конец C++',
                course=course_cpp
            )
